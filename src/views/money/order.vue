<template>
  <div class="app-container">
    ...
    <pagination v-show="total>0" :total="total" :page.sync="listQuery.page" :limit.sync="listQuery.per_page" @pagination="getMoneyOrder"/>
  ...
  export default {
    ...
    methods: {
      ...
      async getMoneyOrder() {
        ...
        const res = await getMoneyOrders(this.listQuery)
